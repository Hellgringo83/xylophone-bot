...
const char SONG_INDIANA_JONES[] PROGMEM = "160,4/4,e4f8g4C2e4f4g4";
const char NAME_FAST_BOY[] PROGMEM = "Fast Boy";
const char SONG_FAST_BOY[] PROGMEM = "260,4/4,c16e16g16c16e16g16d16f16a16d16f16a16c16e16g16c16e16g16";
const char NAME_LEAN_ON_ME[] PROGMEM = "Lean on Me";
const char SONG_LEAN_ON_ME[] PROGMEM = "160,4/4,c4d4e4f2f4e4d4c2c4d4e4e2d4c4d2";
const char NAME_EYE_OF_THE_TIGER[] PROGMEM = "Eye of the Tiger";
const char SONG_EYE_OF_THE_TIGER[] PROGMEM = "160,4/4,a2a4g4a2a4g4a2a4e4f1a2a4g4a2a4g4a2a4e4f1";
const char NAME_SATISFACTION[] PROGMEM = "Satisfaction";
const char SONG_SATISFACTION[] PROGMEM = "160,4/4,a4a2a4b4C2C4C4b4b4a1a4a2a4b4C2C4C4b4b4a1";
const char NAME_DRUMM_T[] PROGMEM = "Drumm t";
const char SONG_DRUMM_T[] PROGMEM = "160,4/4,t16t16t16t16t16t16t16t16";
const char NAME_DRUMM_BIG_T[] PROGMEM = "Drumm T";
const char SONG_DRUMM_BIG_T[] PROGMEM = "160,4/4,T16T16T16T16";
const char NAME_DRUM_SONG[] PROGMEM = "Drum Song";
const char SONG_DRUM_SONG[] PROGMEM = "110,4/4,t8c8e8g8t8e8g8C8T8C8g8e8t8d8f8a8t8c8g8e8T8C8a8g8t8d8f8a8T8C8a8f8t8c8e8g8t8g8e8d8t8c8T8C8g8e8";
...
const PlaylistEntry PLAYLIST[] PROGMEM = {
    ...
    {NAME_FAST_BOY, SONG_FAST_BOY},
    {NAME_LEAN_ON_ME, SONG_LEAN_ON_ME},
    {NAME_EYE_OF_THE_TIGER, SONG_EYE_OF_THE_TIGER},
    {NAME_SATISFACTION, SONG_SATISFACTION},
    {NAME_DRUMM_T, SONG_DRUMM_T},
    {NAME_DRUMM_BIG_T, SONG_DRUMM_BIG_T},
    {NAME_DRUM_SONG, SONG_DRUM_SONG}};
